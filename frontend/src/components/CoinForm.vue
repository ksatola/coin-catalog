...
<template>
  <form class="coin-form" @submit.prevent="submitForm">
    ...
    <section class="form-section">
      ...
      <div class="info-grid">
        ...
        <div class="field-card">
          ...
          <select id="issuer" v-model="form.issuer_id" @click.stop>
            <option :value="null">— brak —</option>
            <option v-for="item in dictionaries.issuers" :key="item.id" :value="item.id">{{ item.name }}</option>
          </select>
        ...
        <div class="field-card">
          ...
          <select id="denomination" v-model.number="form.denomination_id" required @click.stop>
            <option :value="0">Wybierz nominał</option>
            <option v-for="item in dictionaries.denominations" :key="item.id" :value="item.id">{{ item.name }}</option>
          </select>
        ...
        <div class="field-card field-card-wide">
          <div class="date-fields">
            <div>
              ...
              <select id="from-era" v-model.number="form.from_era_id" required @click.stop>
                <option :value="0">Wybierz erę</option>
                <option v-for="item in dictionaries.eras" :key="item.id" :value="item.id">{{ item.name }}</option>
              </select>
        ...
        <div class="field-card field-card-wide">
          <div class="date-fields">
            <div>
              ...
              <select id="to-era" v-model.number="form.to_era_id" required @click.stop>
                <option :value="0">Wybierz erę</option>
                <option v-for="item in dictionaries.eras" :key="item.id" :value="item.id">{{ item.name }}</option>
              </select>
              <InlineDictionaryCreate dictionary-name="eras" label="erę" @created="addDictionaryItem('eras', $event)" />
        ...
        <div class="field-card">
          ...
          <select id="mint" v-model="form.mint_id" @click.stop>
            <option :value="null">— brak —</option>
            <option v-for="item in dictionaries.mints" :key="item.id" :value="item.id">{{ item.name }}</option>
          </select>
        ...
        <div class="field-card">
          ...
          <select id="material" v-model="form.material_id" @click.stop>
            <option :value="null">— brak —</option>
            <option v-for="item in dictionaries.materials" :key="item.id" :value="item.id">{{ item.name }}</option>
          </select>
        ...
        <div class="field-card">
          ...
          <select id="state" v-model="form.state_id" @click.stop>
            <option :value="null">— brak —</option>
            <option v-for="item in dictionaries.states" :key="item.id" :value="item.id">{{ item.name }}</option>
          </select>
    ...
    <section class="form-section">
      ...
      <div class="text-fields">
        <label class="field-card">Źródło <input v-model="form.source" type="text" /></label>
...
.primary-image-card h4 {
  margin: 0;
  font-size: 0.95rem;
}

.primary-image-card :deep(.image-drop-zone) {
  width: 100%;
...
.primary-image-card :deep(.image-drop-zone.has-image) {
  background: #ffffff;
}

.primary-image-card :deep(.preview-image) {
  width: 100%;
  height: 100%;
  object-fit: contain;
  border-radius: 8px;
...
.text-fields .field-card:last-child {
  min-height: 190px;
}
...
.coin-form :deep(button:focus-visible),
.coin-form input:focus-visible,
.coin-form select:focus-visible,
.coin-form textarea:focus-visible {
